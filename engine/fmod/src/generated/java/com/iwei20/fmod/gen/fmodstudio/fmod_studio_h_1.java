...
class fmod_studio_h_1 extends fmod_studio_h$shared {
    ...
    private static final int FMOD_VERSION = (int)131860L;
    /**
     * {@snippet lang=c :
     * #define FMOD_VERSION 131860
     * }
     */
    public static int FMOD_VERSION() {
        return FMOD_VERSION;
    }
    private static final int FMOD_BUILDNUMBER = (int)164239L;
    /**
     * {@snippet lang=c :
    ...
    private static final int FMOD_DSP_PARAMETER_DATA_TYPE_FINITE_LENGTH = (int)-8L;
    /**
     * {@snippet lang=c :
     * enum <anonymous>.FMOD_DSP_PARAMETER_DATA_TYPE_FINITE_LENGTH = -8
     * }
     */
    public static int FMOD_DSP_PARAMETER_DATA_TYPE_FINITE_LENGTH() {
        return FMOD_DSP_PARAMETER_DATA_TYPE_FINITE_LENGTH;
    }
    /**
     * {@snippet lang=c :
    ...
    private static class FMOD_System_CreateDSPConnection {
        ...
        public static final MemorySegment ADDR = SYMBOL_LOOKUP.findOrThrow("FMOD_System_CreateDSPConnection");
