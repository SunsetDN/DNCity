...
public class fmod_h extends fmod_h_1 {
    ...
    private static class FMOD_DSP_AddInputPreallocated {
        public static final FunctionDescriptor DESC = FunctionDescriptor.of(
            fmod_h.C_INT,
            fmod_h.C_POINTER,
            fmod_h.C_POINTER,
        ...
        public static final MemorySegment ADDR = SYMBOL_LOOKUP.findOrThrow("FMOD_DSP_AddInputPreallocated");
     ...
     * Function descriptor for:
     * {@snippet lang=c :
     * FMOD_RESULT FMOD_DSP_AddInputPreallocated(FMOD_DSP *dsp, FMOD_DSP *input, FMOD_DSPCONNECTION **connection)
     * }
     */
    public static FunctionDescriptor FMOD_DSP_AddInputPreallocated$descriptor() {
        return FMOD_DSP_AddInputPreallocated.DESC;
    }
     ...
     * }
     */
    public static MethodHandle FMOD_DSP_AddInputPreallocated$handle() {
        return FMOD_DSP_AddInputPreallocated.HANDLE;
    }
     ...
     * }
     */
    public static MemorySegment FMOD_DSP_AddInputPreallocated$address() {
        return FMOD_DSP_AddInputPreallocated.ADDR;
    }
     ...
     * }
     */
    public static int FMOD_DSP_AddInputPreallocated(MemorySegment dsp, MemorySegment input, MemorySegment connection) {
        var mh$ = FMOD_DSP_AddInputPreallocated.HANDLE;
        try {
            if (TRACE_DOWNCALLS) {
                traceDowncall("FMOD_DSP_AddInputPreallocated", dsp, input, connection);
            }
            return (int)mh$.invokeExact(dsp, input, connection);
        } catch (Error | RuntimeException ex) {
           throw ex;
        } catch (Throwable ex$) {
           throw new AssertionError("should not reach here", ex$);
