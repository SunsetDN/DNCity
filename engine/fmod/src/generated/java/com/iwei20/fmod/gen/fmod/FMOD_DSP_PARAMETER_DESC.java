...
public class FMOD_DSP_PARAMETER_DESC {
    ...
    public static byte label(MemorySegment struct, long index0) {
        return (byte)label$ELEM_HANDLE.get(struct, label$OFFSET, index0);
    }
    ...
    public static void label(MemorySegment struct, long index0, byte fieldValue) {
        label$ELEM_HANDLE.set(struct, label$OFFSET, index0, fieldValue);
    }
    ...
    private static final GroupLayout floatdesc$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$184:5"), groupElement("floatdesc"));
    ...
    private static final long floatdesc$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$184:5"), groupElement("floatdesc"));
    ...
    private static final GroupLayout intdesc$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$184:5"), groupElement("intdesc"));
    ...
    private static final long intdesc$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$184:5"), groupElement("intdesc"));
    ...
    private static final GroupLayout booldesc$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$184:5"), groupElement("booldesc"));
    ...
    private static final long booldesc$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$184:5"), groupElement("booldesc"));
    ...
    private static final GroupLayout datadesc$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$184:5"), groupElement("datadesc"));
    ...
    private static final long datadesc$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$184:5"), groupElement("datadesc"));
